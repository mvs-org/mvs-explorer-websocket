...
connection.onopen = function(session, details) {
    ...
    switch (config.task) {
        case 'TRANSACTIONS':
        let txs1 = require('./models/transactions.js')();
        setup_schedules(txs1, 'public.transactions', config.timer.transactions);
        break;
        case 'BLOCKS':
            let block = require('./models/block.js')();
            setup_schedules(block, 'public.blocks', config.timer.blocks);
            break;
    }
